...
public class CobSpecRoutes {
    public static Handler generate(Router router, Repository dataStore) {
        Handler updatedRouter = router
                .setRoute("/form", new String[] {"GET", "PUT", "POST", "DELETE"}, new FormHandler(dataStore))
                .setRoute("/method_options", new String[] {"GET", "HEAD", "POST", "PUT"}, new OptionsHandler())
                .setRoute("/method_options2", new String[] {"GET"}, new OptionsHandler())
