...
public class RequestParamsParser extends BasicRequestParser {
    ...
    private Map<String, String> parseParams(String queryParams) throws UnsupportedEncodingException {
    ...
    private Map<String, String> putArgAndValue(Map<String, String> finalParams, String param) throws UnsupportedEncodingException {
        if (param.contains("=")) {
